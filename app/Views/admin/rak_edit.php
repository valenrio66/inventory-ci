...
<main class="content">
	<div class="container-fluid p-0">
		<h5 class="right-aligned" style="float: right">
			<a href="#">Home</a> / <a href="#">Rak</a> / Edit Rak
		</h5>  
		<h1 class="h3 mb-3"><b>Edit Rak</b></h1>
		<div class="row">
			<div class="col-12">
				<form id="updateRak" action="<?= base_url('/rak/update/' . $raks['id']) ?>" method="post">
					<div class="card">
						<div class="card-body">
							<div class="row mt-1">
								<div class="col-md-6">
							...
							<div class="row mt-1">
								<div class="col-md-6">
									...
									<input type="text" class="form-control" id="kapasitas_fast" name="kapasitas_fast" value="<?= esc($raks['kapasitas_fast']) ?> cm³"/>
								</div>
								<div class="col-md-6">
									<!-- Inputan Kapasitas Barang Medium Moving -->
									<h5 class="card-title mt-2">Kapasitas Barang Medium Moving</h5>
									<input type="text" class="form-control" id="kapasitas_medium" name="kapasitas_medium" value="<?= esc($raks['kapasitas_medium']) ?> cm³"/>
								</div>
							</div>
							...
							<div class="col-md-12">
								...
								<input type="text" class="form-control" id="kapasitas_slow" name="kapasitas_slow" value="<?= esc($raks['kapasitas_slow']) ?> cm³"/>
							</div>
...
<script src="<?= base_url('js/rak/update.js') ?>"></script>