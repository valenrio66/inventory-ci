	...
	<div class="container-fluid p-0">
		...
		<div class="col-md-6 mb-3">
			<div class="d-flex justify-content-start">
				<a href="<?= base_url('/dashboard/gudang/add') ?>" type="button" class="btn btn-info me-2">
								...
								<tbody>
									<?php foreach ($gudangs as $gudang) : ?>
										<tr>
											...
											<td>
												<?= number_format($gudang['kapasitas'] / 1000000, 3) ?> m³
											</td>
											<td>
												<?= $gudang['alamat'] ?>
											</td>
											...
											<td>
												...
												<a href="<?= base_url('gudang/delete/' . $gudang['id_gudang']) ?>" class="btn btn-danger" onclick="return confirmDelete(event)">Hapus</a>
											</td>
										</tr>
									<?php endforeach; ?>
								</tbody>
