...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 02, 2024 at 01:21 PM
...
INSERT INTO `box` (`id_box`, `id_rak`, `tipe_box`, `kapasitas_tersedia`, `kapasitas_terpakai`) VALUES
(1, 3, 'Fast Moving', -5042, 5200);
...
('D6DL1611', 'Sparepart Mobil', 1, 'Fast Moving', 'Daihatsu', '6DL16', 'E160300080A', '', 13, 'PC', 18700, 243100, 11, 5200, '2024-08-02 18:20:00');
...
INSERT INTO `rak` (`id`, `nomor_rak`, `id_gudang`, `kapasitas_fast`, `kapasitas_medium`, `kapasitas_slow`) VALUES
(3, 101, 2, -4200, 1000, 1000);
...
--
ALTER TABLE `gudang`
  MODIFY `id_gudang` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
